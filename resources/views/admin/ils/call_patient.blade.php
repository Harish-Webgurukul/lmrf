                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4 col-md-6">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">ILS FollowUp Call >
                                @if ($pending_call ?? false)
                                    Pending Call
                                @else
                                    New Call
                        ...
                        <div class="card-body">
                            <form method="post" action="{{ route('ils.ils_call_update', ['id' => $patient->id]) }}">
                                @csrf
                                            ...
                                            <td>
                                                <div class="form-group form-check">
                                                    <input type="checkbox" class="form-check-input" id="ilscheck"
                                                        name="ils_resolve" value="true">
                                                    <label class="form-check-label" for="ilscheck">Check if ILS Resolve</label>
                                                </div>
