                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="patient_card p-2">
                                            ...
                                            <small>Call Date:{{$ilsfollowup->call_date}}</small>
                                        </td>
                                        <td class="d-flex  flex-column align-content-between">

                                            <a class="btn btn-sm btn-primary mb-1" href="{{ route('call_patient', $ilsfollowup->id) }}"><i class="fas fa-fw fa-phone-volume"></i></a>
